...
// Source: github.com/luxfi/ledger-lux-go/keychain (interfaces: Ledger)
//
// Generated by this command:
//
//	mockgen -package=keychain -destination=keychain/mock_ledger.go github.com/luxfi/ledger-lux-go/keychain Ledger
//
...
func (m *MockLedger) Version() (uint32, uint32, uint32, error) {
	m.ctrl.T.Helper()
